...
import com.pres.servlets.servlet.user.ProfileServlet;
...
public class RegistrationServletTest {
    ...
    @Test
    public void testPostIfExistLogin() throws ServletException, IOException, DBException {
        ...
        Mockito.when(testRequest.getParameter("login")).thenReturn(login);
        Mockito.when(mock.isLoginExist(login)).thenReturn(true);
    ...
    @Test
    public void testPostIfNotExistLogin() throws ServletException, IOException, DBException {
        UserRepository mock = PowerMockito.mock(UserRepository.class);
        mockStatic(UserRepository.class);
        PowerMockito.when(UserRepository.getInstance()).thenReturn(mock);
